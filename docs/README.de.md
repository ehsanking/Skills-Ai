...
| Datei | Für |
|---|---|
| [`SkillsAI.apk`](https://github.com/ehsanking/Skills-Ai/releases/latest/download/SkillsAI.apk) — 64 MB | Jedes Android-Telefon: arm64, 32-Bit-ARM und x86 in einer Datei. Android 8.0 und neuer. |

Eine Datei für jedes Telefon — es gibt nichts auszuwählen.
