...
| الملف | لِـ |
|---|---|
| [`SkillsAI.apk`](https://github.com/ehsanking/Skills-Ai/releases/latest/download/SkillsAI.apk) — 64 ميغابايت | كل هواتف أندرويد: arm64 وARM 32-بت وx86 في ملف واحد. أندرويد 8.0 فما فوق. |

ملف واحد لكل الهواتف، فلا شيء تختاره.
