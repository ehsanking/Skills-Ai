...
| फ़ाइल | किसके लिए |
|---|---|
| [`SkillsAI.apk`](https://github.com/ehsanking/Skills-Ai/releases/latest/download/SkillsAI.apk) — 64 MB | हर Android फ़ोन: arm64, 32-बिट ARM और x86 एक ही फ़ाइल में। Android 8.0 और उससे ऊपर। |

हर फ़ोन के लिए एक ही फ़ाइल, इसलिए चुनने को कुछ नहीं है।
